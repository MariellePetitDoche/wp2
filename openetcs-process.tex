...
specification. If available, the part of the system architecture  model
concerning the software will be further refined to ensure traceability of the
...
{\bf Documents:} SW testing specification (see A.2)
